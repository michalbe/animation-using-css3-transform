var canvas = document.createElement('div');
    ...
    while(numberOfPinguins--) {
        ...
        pinguins[numberOfPinguins].div.style.left = Math.random()*480;
        pinguins[numberOfPinguins].div.style.top = Math.random()*760;
        pinguins[numberOfPinguins].div.appendChild(pinguins[numberOfPinguins].image);
        pinguins[numberOfPinguins].image.style.position = "absolute";
...
var MainLoop = function(){
    ...
    while(numberOfPinguins--) {
        ...
        pinguins[numberOfPinguins].image.style.top = height * pinguins[numberOfPinguins].actualFrame*-1;
        pinguins[numberOfPinguins].div.style.left = pinguins[numberOfPinguins].left;
        pinguins[numberOfPinguins].div.style.top = pinguins[numberOfPinguins].top;
